...
int main()
{
    init(1.0f, 1.0f, 1.0f, false, true, 0.1745329f);
    saveresult(0.001, "simple_harmonic_10.csv", 4.0);

    init(1.0f, 1.0f, 1.0f, false, true, 0.5235988f);
    saveresult(0.001, "simple_harmonic_30.csv", 4.0);

    init(1.0f, 1.0f, 1.0f, false, true, 1.5533430f);
    saveresult(0.001, "simple_harmonic_89.csv", 4.0);

    init(1.0f, 1.0f, 1.0f, false, false, 0.1745329f);
    saveresult(0.001, "exact_10.csv", 4.0);

    init(1.0f, 1.0f, 1.0f, false, false, 0.5235988f);
    saveresult(0.001, "exact_30.csv", 4.0);

    init(1.0f, 1.0f, 1.0f, false, false, 1.5533430f);
    saveresult(0.001, "exact_89.csv", 4.0);

    init(1.0f, 1.0f, 1.0f, false, false, 1.5533430f);
    saveresult(0.001, "air_resistance_no_89.csv", 10.0);

    init(1.0f, 1.0f, 1.0f, true, false, 1.5533430f);
